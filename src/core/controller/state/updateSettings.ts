...
export async function updateSettings(controller: Controller, request: UpdateSettingsRequest): Promise<Empty> {
	try {
		...
		// Subagent API configuration (optional override of main API)
		if (request.subagentUseMainApi !== undefined) {
			controller.stateManager.setGlobalState("subagentUseMainApi", !!request.subagentUseMainApi)
		}
		if (request.subagentApiProvider !== undefined) {
			controller.stateManager.setGlobalState("subagentApiProvider", convertProtoToApiProvider(request.subagentApiProvider))
		}
		if (request.subagentApiModelId !== undefined) {
			controller.stateManager.setGlobalState("subagentApiModelId", request.subagentApiModelId)
		}
		if (request.subagentApiKey !== undefined) {
			controller.stateManager.setGlobalState("subagentApiKey", request.subagentApiKey)
		}
		if (request.subagentApiBaseUrl !== undefined) {
			controller.stateManager.setGlobalState("subagentApiBaseUrl", request.subagentApiBaseUrl)
		}
