...
const AgentBaseConfigSchema = z.object({
	...
	/**
	 * Optional per-subagent API configuration overrides.
	 *
	 * This object is merged on top of the main agent's ApiConfiguration when
	 * building the subagent's ApiHandler. It enables subagents to use different
	 * providers, API keys, base URLs, headers, etc.
	 *
	 * Note: This lives in the agent config YAML file by design (no storage/proto wiring).
	 */
