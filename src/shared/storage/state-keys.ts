...
export type ApiProfile = {
	...
	name: string
	updatedAt: number
	/** API handler options (non-secret). */
	options: Record<string, unknown>
	/** Optional secrets override. If omitted, keep existing secrets. */
...
const USER_SETTINGS_FIELDS = {
	...
	// API Profiles (presets) and active selections
	...
	// Profile button bindings — which profile each title-bar button activates
